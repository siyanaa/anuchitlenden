...
@section('content')
    <div class="mt-4">
        <div class="d-flex justify-content-between mb-4">
            ...
            <div>
                <a href="" class="btn btn-primary add-list" data-bs-toggle="modal" data-bs-target="#createNoTransPurpose">
        ...
        <div class="col-lg-12">
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($noTransactionPurpose as $transactionpurpose)
                            <tr>
                                <th scope="row">
                                    {{ $loop->iteration }}
                                </th>
                ...
                ====================================     --}}
                        ...
                        <div class="modal fade" id="delete{{ $transactionpurpose->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">No</button>
                                        <a href="{{ url('admin/notransactionpurpose/destroy/' . $transactionpurpose->id) }}">
                    ...
                    {{-- =====================================
                            MODAL - ADD
                ====================================     --}}
                    <div class="modal fade" id="createNoTransPurpose" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">लिन दिन नपर्ने गरी फर्छ्यौट सिर्जना</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <form id="quickForm" novalidate="novalidate" method="POST"
                                        action="{{ route('admin.notransactionpurpose.store') }}">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="">
                                                    <div class="form-group">
                                                        <input type="text" name="title" class="form-control"
                                                            id="exampleInputName" placeholder="लिन दिन नपर्ने गरी फर्छ्यौट"
                                                            value="{{ old('title') }}">
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    @foreach ($noTransactionPurpose as $transactionpurpose)
                        <div class="modal fade" id="edit{{ $transactionpurpose->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">लिन दिन नपर्ने गरी फर्छ्यौट सम्पादन</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <form id="quickForm" novalidate="novalidate" method="POST"
                                            action="{{ route('admin.notransactionpurpose.update', ['id' => $transactionpurpose->id]) }}">
