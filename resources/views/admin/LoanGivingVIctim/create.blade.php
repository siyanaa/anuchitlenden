                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   value="{{ old('loan_giving_applicant_basic_detail.applicant_fathers_no') }}" id="applicant_fathers_no" name="loan_giving_applicant_basic_detail[applicant_fathers_no]" class="input-text" maxlength="10" placeholder="१० अंककाे नंबर" autofocus oninput="validatePhoneNumber(this, 'phoneNumberError')" min="1" required>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ old('loan_giving_applicant_basic_detail.applicant_spouse_no') }}"
                                   ...
                                   class="input-text" maxlength="10" placeholder="१० अंककाे नंबर" autofocus min="1" required
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select id="annual_income" name="loan_giving_applicant_basic_detail[applicant_annual_income]" class="form-control" autofocus>
                                ...
                                <option value="1-5" {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '1-5' ? 'selected' : '' }}>१ लाख देखि  ५ लाख</option>
                                <option value="5-10" {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '5-10' ? 'selected' : '' }}>५ लाख देखि १० लाख</option>
                                <option value="10-20" {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '10-20' ? 'selected' : '' }}>१० लाख देखि  २० लाख</option>
                                <option value="20+" {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '20+' ? 'selected' : '' }}>२० लाख +</option>
                            </select>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select id="occupation" name="loan_giving_applicant_basic_detail[applicant_occup]" class="form-control" autofocus>
                                ...
                                <option value="teacher" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'teacher' ? 'selected' : '' }}>शिक्षक</option>
                                <option value="engineer" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'engineer' ? 'selected' : '' }}>अभियंता</option>
                                <option value="doctor" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'doctor' ? 'selected' : '' }}>डॉक्टर</option>
                                <option value="lawyer" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'lawyer' ? 'selected' : '' }}>वकील</option>
                                <option value="business" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'business' ? 'selected' : '' }}>व्यवसाय</option>
                                <option value="farmer" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'farmer' ? 'selected' : '' }}>किसान</option>
                                <option value="other" {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'other' ? 'selected' : '' }}>अन्य</option>
                            </select>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="loan_giving_applicant_finance_cond[home_type][]">
                                    ...
                                    <option value="कच्ची"
                                        {{ old('loan_giving_applicant_finance_cond.home_type') == 'कच्ची' ? 'selected' : '' }}>
                                        कच्ची</option>
                                    <option value="पक्की"
                                        {{ old('loan_giving_applicant_finance_cond.home_type') == 'पक्की' ? 'selected' : '' }}>
                                        पक्की</option>
                                    <option value="अन्य"
                                        {{ old('loan_giving_applicant_finance_cond.home_type') == 'अन्य' ? 'selected' : '' }}>
                                        अन्य</option>
                                </select>
                                @php
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group" data-input-type="land_area">
                    ...
                    <div class="input-group">
                        <input type="number" value="{{ old('loan_giving_applicant_finance_cond.land_area.0') }}" id=""
        ...
        $(document).on('click', '.remove-field', function() {
            ...
            if ($('.land-details-block').length === 1) {
                ...
                @endif
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="">ग. चल सम्पत्तिको विवरण <span class="star">*</span></label>
                            <div class="dropdown-container">
                                @php
                                    // Get old values if they exist
...
<span class="application_second_title">ङ. बैङ्क तथा वित्तिय संस्था (सहकारी/लघुवित्त समेत) मा खोलिएको बैंक खाता विवरण :</span>
...
<span class="application_second_title">च. बैङ्क तथा वित्तिय संस्था (सहकारी/लघुवित्त समेत) बाट ऋण लिएको भए:</span>
