...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">सिस्टम इतिहास</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                            ...
                            <thead>
                                <tr role="row">
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        ...
                                        aria-label="Rendering engine: activate to sort column descending">सि.नं.
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        aria-label="Browser: activate to sort column ascending">विवरण</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        aria-label="Platform(s): activate to sort column ascending">युजर आईडी</th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        aria-label="Platform(s): activate to sort column ascending">IP address</th>
                                    <th class="non-sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">समय</th>
                                </tr>
                            </thead>
