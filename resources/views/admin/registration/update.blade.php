                        ...
                        <div id="applicant_ids">
                            ...
                            @foreach ($registration->applicant as $key => $applicants)
                                <div class="d-flex flex-wrap" id="addApplicant1">
                                    ...
                                    <div class="form-group col-md-4 col-xs-12">
                                        <label>निवेदकको सम्पर्क नं.</label>

                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $applicants->contact }}" id="a_contact"
                                                name="applicant[contact][]" class="input-text">
                                        </div>
                                    </div>
                    ...
                    <div class="tab">
                        ...
                        @foreach ($registration->offender as $key => $offenders)
                            <div class="d-flex flex-wrap" id="addOffender1">
                                ...
                                <div class="form-group col-md-4 col-xs-12">
                                    <label>विपक्षी/साहुको सम्पर्क नं.</label>

                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $offenders->contact }}" id="o_contact"
                                            name="offender[contact][]" class="input-text">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addApplicantRow").click(function() {
                ...
                html +=
                    '<div class="form-group col-md-4 col-xs-12"> <label>Applicant Contact No. <em>*</em> </label><div class="col-sm-10"><input type="text" id="a_contact" name="applicant[contact][]" class="input-text"> </div></div>';
                ...
                html +=
                    '<div class="form-group col-md-4 col-xs-12"><label>Applicant Wada No. <em>*</em> </label><div class="col-sm-10"><select id="a_wada_id" name="applicant[wada_id][]" class="form-control col-md-12" required><option disabled selected value>Select Local Government Wada</option><option value="1">Wada No.1</option><option value="2">Wada No.2</option><option value="3">Wada No.3</option><option value="4">Wada No.4</option><option value="5">Wada No.5</option><option value="6">Wada No.6</option><option value="7">Wada No.7</option><option value="8">Wada No.8</option><option value="9">Wada No.9</option><option value="10">Wada No.10</option><option value="11">Wada No.11</option><option value="12">Wada No.12</option><option value="13">Wada No.13</option><option value="14">Wada No.14</option><option value="15">Wada No.15</option><option value="16">Wada No.16</option><option value="17">Wada No.17</option><option value="18">Wada No.18</option><option value="19">Wada No.19</option><option value="20">Wada No.20</option><option value="21">Wada No.21</option><option value="22">Wada No.22</option><option value="23">Wada No.23</option><option value="24">Wada No.24</option><option value="25">Wada No.25</option><option value="26">Wada No.26</option><option value="27">Wada No.27</option><option value="28">Wada No.28</option><option value="29">Wada No.29</option><option value="30">Wada No.30</option><option value="31">Wada No.31</option><option value="32">Wada No.32</option><option value="33">Wada No.33</option><option value="34">Wada No.34</option><option value="35">Wada No.35</option></select></div></div>';
                html +=
            ...
            $("#addOffenderRow").click(function() {
                ...
                html +=
                    '<div class="form-group col-md-4 col-xs-12"> <label>Applicant Contact No. <em>*</em> </label><div class="col-sm-10"><input type="text" id="o_contact" name="offender[contact][]" class="input-text"> </div></div>';
