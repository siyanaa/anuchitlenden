        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <div class="row">
                        <div class="col-sm-12">
                            <form id="r2" method="POST" action="{{ route('admin.reports.agreement_no_implementation_details') }}">
                                @include('admin.includes.search-form')
                            </form>

                            <a href="{{ route('admin.reports.export_agreement_no_implementation_details', $searchParams) }}" class="btn btn-success">निर्यात गर्नुहाेस <i class="fas fa-file-download"></i></a>

                            <a href="{{ route('admin.reports.agreement_no_implementation_detailsshow') }}" class="btn btn-sm btn-secondary ">Print</a>
                                ...
                                <table id="releases-table" class="table table-bordered table-striped dataTable dtr-inline"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2">विपक्षी साहुबाट माग रकम</th>
                                            ...
                                            <th rowspan="2">सहमती कार्यान्वयन हदम्यादको अन्तिम मिति</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach ($registration_reports as $registration)
                                            ...
                                            {{-- Offender Refund On Release --}}
                                            {{-- <td>फिर्ता गर्नुपर्ने प्रमाण</td> --}}
