                ...
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="{{ route('admin.reports.export_collective_details') }}" class="btn btn-success">निर्यात गर्नुहाेस <i class="fas fa-file-download"></i></a>
                            <a href="{{ route('admin.reports.collectivesshow') }}" class="btn btn-sm btn-secondary ">Print</a>
