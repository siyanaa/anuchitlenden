...
class VictimApplicationsController extends Controller
{
    /**
    ...
    {
        $page_title = 'पीडितले भर्ने निवेदन फाराम';
        ...
        return view('admin.victim.create', compact('states', 'purposes', 'proofs', 'natures', 'page_title'));
    }
    public function rinindex()
    {
        $page_title = 'ऋण दिने पीडितले भर्ने निवेदन फाराम';
        $states = State::select('name', 'id')->get();
        $natures = Nature::select('title', 'id')->get();
        $proofs = Proof::select('title', 'id')->get();
        $purposes = Purpose::select('title', 'id')->get();
        return view('admin.victimsahu.create', compact('states', 'purposes', 'proofs', 'natures', 'page_title'));
    }
