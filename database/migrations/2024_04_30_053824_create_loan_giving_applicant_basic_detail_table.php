...
return new class extends Migration
{
    ...
    {
        Schema::create('loan_giving_applicant_basic_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('loan_giving_applicant_basic_detail');
    }
};
